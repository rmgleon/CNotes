...
node_editor(struct nk_context *ctx)
{
    ...
    if (nk_begin(ctx, "NodeEdit", nk_rect(WINDOW_WIDTH*80/100, 35, WINDOW_WIDTH-(WINDOW_WIDTH*80/100), WINDOW_HEIGHT - WINDOW_HEIGHT_OFFSET),
        NK_WINDOW_BORDER | NK_WINDOW_NO_SCROLLBAR | NK_WINDOW_MOVABLE | NK_WINDOW_MINIMIZABLE | NK_WINDOW_SCALABLE ))
    {
